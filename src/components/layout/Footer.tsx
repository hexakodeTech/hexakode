  ...
  return (
    <footer className="bg-primary-container text-on-primary-container relative w-full border-t border-outline-variant/10">
      ...
      <div className="hidden md:block">
          ...
          <div className="flex flex-col items-start md:col-span-2">
            ...
            <div>
              ...
              <ul className="space-y-4 font-body-sm text-body-sm">
                ...
                <li>
                  <Link href="/cookie-policy" className="text-on-primary-container/70 hover:text-white transition-colors duration-300">
                    Cookie Policy
                  </Link>
                </li>
              </ul>
        ...
        {/* Mobile Footer (Screens below 768px) */}
        <div className="block md:hidden px-margin-mobile py-10 max-w-md mx-auto">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <Brand variant="footer-mobile" />
            <p className="text-on-primary-container/70 max-w-sm mt-3 text-body-sm leading-relaxed">
              We build websites, mobile apps, and digital solutions that help businesses grow.
            </p>
          </div>

          {/* Brand → Social: 24px spacing */}
            ...
            {SOCIAL_LINKS.filter(
                  ...
                  case "instagram":
                    return (
                      <svg className="w-6 h-6" viewBox="0 0 24 24">
                        <defs>
                          <linearGradient id="footer-instagram-grad-mobile" x1="0%" y1="100%" x2="100%" y2="0%">
                            <stop offset="0%" stopColor="#fdf497" />
                            <stop offset="5%" stopColor="#fdf497" />
                            <stop offset="45%" stopColor="#fd5949" />
                            <stop offset="60%" stopColor="#d6249f" />
                        ...
                        <path fill="url(#footer-instagram-grad-mobile)" d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.051.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/>
                      </svg>
                    );
                  case "twitter":
                    return (
              ...
              return (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`w-11 h-11 flex items-center justify-center rounded-full bg-white/5 border border-white/10 transition-all duration-300 ease-out hover:scale-110 active:scale-95 hover:bg-white/10 ${glowClass}`}
                  style={{ color: link.color }}
                  title={link.platform}
                  aria-label={link.platform}
                >
          ...
          {/* Social → Quick Links: 32px spacing */}
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="flex flex-col items-center space-y-4 font-body-sm text-body-sm">
              <li>
                <Link href="/" className="text-on-primary-container/70 hover:text-white transition-colors duration-300">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-on-primary-container/70 hover:text-white transition-colors duration-300">
                  Services
                </Link>
              </li>
              <li>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center space-y-3 font-body-sm text-body-sm">
              <a href="mailto:contact@hexakode.in" className="text-on-primary-container/70 hover:text-white transition-colors duration-300">
                contact@hexakode.in
              </a>
              <a href="https://www.hexakode.in" target="_blank" rel="noopener noreferrer" className="text-on-primary-container/70 hover:text-white transition-colors duration-300">
                www.hexakode.in
              </a>
            </div>
          </div>

          {/* Contact → Copyright: 32px spacing */}
          <div className="w-full border-t border-outline-variant/10 my-4" />
