        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="font-body-md text-body-md text-on-surface-variant mb-12 leading-relaxed">
              Founded by a collective of senior systems architects and product designers, HexaKode was born from a simple realization: the digital landscape needed more than just code—it needed architectural integrity. We started as a specialized consultancy and have grown into a full-cycle engineering partner for Fortune 500 companies.
            </motion.p>
