...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center pt-28 pb-16 md:py-32 overflow-hidden bg-white">
      ...
      <div className="absolute top-1/4 right-0 w-96 h-96 bg-sky-500/5 rounded-full filter blur-[100px] pointer-events-none" />
      ...
      <Container className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left max-w-2xl animate-fade-in-up">
          <span className="inline-flex items-center px-3.5 py-1.5 rounded-full text-xs font-bold tracking-widest uppercase mb-6 bg-sky-50 text-sky-600 border border-sky-100/80 shadow-[0_2px_10px_rgba(14,165,233,0.04)]">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-navy-dark leading-[1.08] mb-6">
            ...
            <span className="text-sky-600 relative inline-block">
              That
              <span className="absolute -bottom-1 left-0 w-full h-[3px] bg-gradient-to-r from-sky-400 to-cyan-400 rounded-full" />
            </span>{" "}
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto">
            <PrimaryButton href="#contact" variant="dark" showArrow>
              Start Your Project
            </PrimaryButton>
        ...
        <div className="lg:col-span-5 flex justify-center items-center relative select-none">
          <div className="relative w-full max-w-[420px] aspect-square rounded-2xl bg-gradient-to-b from-slate-50/50 to-slate-100/50 p-4 border border-slate-100 shadow-premium">
            ...
            <div className="absolute inset-0 -m-6 bg-sky-500/10 rounded-full filter blur-3xl opacity-60 pointer-events-none" />
