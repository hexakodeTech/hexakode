...
export default function ProcessCard({ step, index }: ProcessCardProps) {
  ...
  return (
    <div className="relative bg-white rounded-2xl p-8 border border-slate-100/80 shadow-card flex flex-col items-center text-center transition-all duration-300 hover:shadow-premium hover:translate-y-[-4px]">
